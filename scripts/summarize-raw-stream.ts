...
const file =
  process.argv[2] ??
  path.resolve("data/experiments/deepseek-raw/2026-07-04T17-29-06-508Z.jsonl");
...
console.log("delta keys seen:", Object.fromEntries([...deltaKeys.entries()].sort((a, b) => b[1] - a[1])));
