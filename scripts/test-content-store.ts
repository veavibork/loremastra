...
const filled = fillTextGeneration(db, replyText.id, { genPackage: "The door creaks open into darkness." });
...
assert(getText(db, replyText.id)!.genPackage === "The door creaks open into darkness.", "original generation preserved");
