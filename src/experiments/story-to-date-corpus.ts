/**
 * Story-to-date experiment helpers — corpus export, block merge, response parsing.
 * Used by scripts/story-to-date-experiment.ts only; not wired into production assembly yet.
 */
